...
//                   <button
//                     type="button"
//                     className=" block px-4 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-[#266663] rounded-lg border border-gray-300 rounded-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
//                     onClick={() => setShowModal(true)} >Fitur Table
//                   </button>
//                 </div>
//               </label>
//               <label className="block mt-4 text-sm mb-4">
...
//                   <h3 className="text-3xl text-black-400 font-semibold">Add Name Class</h3>
//                 </div>
//                 {/*body*/}
...
//                     <label>Name</label>
//                     <input
//                       className="col  px-4 py-2 rounded-lg text-sm border border-gray-600 bg-white-700 focus:border-purple-400  focus:outline-none  text-gray-300 focus:shadow-outline-gray" placeholder="Enter your name" required
//                     // value={fullName}
