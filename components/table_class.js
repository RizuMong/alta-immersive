              ...
              <label className="block mt-4 text-sm mb-4">
                <div className=" text-gray-500 focus-within:text-purple-600 flex justify-end">
                  ...
                  <button
                    ...
                    onClick={() => setShowModal(true)} >Add New Class
                  </button>
                </div>
              </label>
                ...
                <div className="w-full overflow-x-auto overflow-x-auto relative border-solid-black">
                  <table className="w-full whitespace-no-wrap w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody className=" divide-y divide-gray-700 bg-gray-800">
                      <>
                        <tr className="bg-white border-[#E6E6E6] dark:bg-gray-800">
                        ...
                        <tr className="bg-white border-[#E6E6E6] dark:bg-gray-800">
                          <th scope="row" className="py-5 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            2
                          </th>
                          <td className="py-4 px-6">
            ...
            <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-[#F8F8F8] outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-gray-700 rounded-t">
                  <h3 className="text-3xl text-black-400 font-semibold">New Class</h3>
                </div>
                {/*body*/}
                <div className="relative p-6 flex-auto">
                  <form className="flex flex-col text-black-400 gap-2">
                    ...
                    <input
                      className="col  px-4 py-2 rounded-lg text-sm border border-gray-600 bg-white-700 focus:border-purple-400  focus:outline-none  text-gray-300 focus:shadow-outline-gray" placeholder="Name class" required
                    // value={fullName}
                    ...
                    <div id="dropdown" className="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700">
                      <ul className="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                        <li>
                          <a href="#/action-1" className="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Active</a>
                        </li>
                        <li>
                          <a href="#/action-2" className="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Non-Active</a>
                        </li>
                      </ul>
                    </div>
                  </form>
