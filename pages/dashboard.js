      ...
      <div className="flex">
        ...
        <div className="ml-8 mt-9">
          ...
          <div className="flex gap-12 mt-4">
            <div className="bg-gray-100 h-32 w-80 rounded-lg pl-5 pt-4 text-[#1B1B1B]">
              <h3 className="mb-7 font-semibold text-lg text-[#266663]">
                Mentee Active
              </h3>
              <h4 className="font-semibold text-2xl">10</h4>
            </div>
            <div className="bg-gray-100 h-32 w-80 rounded pl-5 pt-4 text-[#1B1B1B]">
          ...
          <div className="bg-gray-100 mt-11 rounded-lg h-96 w-full">
